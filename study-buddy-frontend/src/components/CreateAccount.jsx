...
function CreateAccount({ open, onClose }) {
  ...
  const handleAreaOfStudyChange = (event) => {
    ...
    if (checked) {
      ...
      setAreaOfStudy((prevSelectedCourses) =>
      ...
      <Box className={styles.loginCreate}>
        ...
        >
          ...
          <FormGroup style={{ display: "flex", alignItems: "center" }}>
            <FormControlLabel
              control={
                <Checkbox checked={isTutor} onChange={handleIsTutorChange} />
              }
          ...
          >
            <div>
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Computer Science")}
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Biology")}
                    onChange={handleAreaOfStudyChange}
                    name="Biology"
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Physics")}
                    onChange={handleAreaOfStudyChange}
                    name="Physics"
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Mathematics")}
                    onChange={handleAreaOfStudyChange}
                    name="Mathematics"
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Chemistry")}
                    onChange={handleAreaOfStudyChange}
                    name="Chemistry"
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Science")}
                    onChange={handleAreaOfStudyChange}
                    name="Science"
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Fine Arts")}
                    onChange={handleAreaOfStudyChange}
                    name="Fine Arts"
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Language")}
                    onChange={handleAreaOfStudyChange}
                    name="Language"
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Literature")}
                    onChange={handleAreaOfStudyChange}
                    name="Literature"
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Engineering")}
                    onChange={handleAreaOfStudyChange}
                    name="Engineering"
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Business")}
                    onChange={handleAreaOfStudyChange}
                    name="Business"
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Political Science")}
                    onChange={handleAreaOfStudyChange}
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Education")}
                    onChange={handleAreaOfStudyChange}
                    name="Education"
                  />
                }
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={areaOfStudy.includes("Social Sciences")}
                    onChange={handleAreaOfStudyChange}
          ...
          >
            <div>
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={prefMeetingType === "physical"}
              ...
              <FormControlLabel
                control={
                  <Checkbox
                    checked={prefMeetingType === "virtual"}
                    onChange={handleMeetingTypeChange}
                    name="virtual"
                  />
                }
